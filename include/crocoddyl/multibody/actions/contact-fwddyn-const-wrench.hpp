/**
 * Add constant wrench to the original contact forward dynamics action model
*/
#ifndef CROCODDYL_MULTIBODY_ACTIONS_CONTACT_FWDDYN_CONST_WRENCH_HPP_
#define CROCODDYL_MULTIBODY_ACTIONS_CONTACT_FWDDYN_CONST_WRENCH_HPP_
...
struct DifferentialActionDataContactFwdDynamicsConstWrenchTpl
  ...
  explicit DifferentialActionDataContactFwdDynamicsConstWrenchTpl(
 ...
 * systems with a constant wrench.
 *
...
class DifferentialActionModelContactFwdDynamicsConstWrenchTpl
 ...
 public:
  ...
  typedef DifferentialActionDataContactFwdDynamicsConstWrenchTpl<Scalar> Data;
  typedef MathBaseTpl<Scalar> MathBase;
   ...
   * @param[in] ids              Ids of the contact frames
   * @param[in] external_wrenches External wrenches
   * @param[in] type             Reference frame of the external wrenches
  ...
  DifferentialActionModelContactFwdDynamicsConstWrenchTpl(
      ...
      const Scalar JMinvJt_damping = Scalar(0.),
      const bool enable_force = false);
  virtual ~DifferentialActionModelContactFwdDynamicsConstWrenchTpl();
 ...
 private:
  ...
  std::vector<pinocchio::FrameIndex> ids_;  //!< Ids of the contact frames
  std::vector<Eigen::Matrix<Scalar, Eigen::Dynamic, 1>> external_wrenches_;  //!< External wrenches
  pinocchio::ReferenceFrame type_;  //!< Reference frame of the external wrenches
};
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include <crocoddyl/multibody/actions/contact-fwddyn-const-wrench.hxx>
